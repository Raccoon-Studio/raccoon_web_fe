...
const features = [
  {
    ...
    description: "Access all AI solutions from a single intuitive dashboard.",
  ...
  },
  {
    icon: Users,
    title: "Collaborative",
    description: "Seamlessly team up and share resources across your organization.",
  ...
  },
  {
    icon: ShieldCheck,
    title: "Compliant",
    description: "Built-in enterprise security and regional data compliance.",
...
export default function SignUpFeatures({ className }: { className?: string }) {
  return (
    <motion.div
